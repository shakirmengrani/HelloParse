                    ...
                    <ul class="row" id="row1">
                        <?php for ($i = 0; $i < count($list); $i++): ?>
                            ...
                            <li class="thumbnail col-lg-3"><h3><a href="#"><?php echo $obj->get("classname"); ?></a></h3>
                                ...
                                <?php echo "<div class=\"col-lg-3\"><b>Field 1 : </b>" . $obj->get("colA") . "<div>"; ?> | 
                                <?php echo "<div class=\"col-lg-3\"><b>Field 2 : </b>" . $obj->get("colB") . "<div>"; ?> <br />
                                <?php echo "<div class=\"col-lg-3\"><b>Field 3 : </b>" . $obj->get("colC") . "<div>"; ?> | 
                                <?php echo "<div class=\"col-lg-3\"><b>Field 4 : </b>" . $obj->get("colD") . "<div>"; ?>
                            </li>
                        <?php endfor; ?>
                    </ul>
                    <h2>Example 2</h2>
